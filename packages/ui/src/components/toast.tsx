...
interface ToastData {
  ...
  /** Hide the close (X) button for this toast. */
  hideClose?: boolean
  /**
...
function ToastBody({
  ...
  // A lone title next to the tall circular icon reads top-hung under
  // items-start; center the row vertically until a description adds height.
  ...
  if (variant === "x") {
    return (
      <ToastPrimitive.Content
        ...
        className={cn(
          "pointer-events-auto flex items-start gap-2.5 overflow-hidden py-2.5 ps-2.5 pe-3 text-sm transition-opacity duration-250 data-behind:opacity-0 data-expanded:opacity-100",
    ...
    <ToastPrimitive.Portal data-slot="toast-portal" {...portalProps}>
      <ToastPrimitive.Viewport
        ...
        className={cn(
          ...
          "data-[position*=top]:top-[calc(var(--toast-inset)+var(--tg-safe-area-inset-top,0px)+var(--tg-content-safe-area-inset-top,0px))]",
          "data-[position*=bottom]:bottom-[calc(var(--toast-inset)+var(--tg-safe-area-inset-bottom,0px)+var(--tg-content-safe-area-inset-bottom,0px))]",
