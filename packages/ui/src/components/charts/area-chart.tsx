...
function ChartInner({
  ...
  // Unique per chart instance — a shared id makes every AreaChart on the page
  // reference the first mounted clipPath, clipping wider charts to its size.
  const reactId = useId()
  const clipPathId = `${reactId}-chart-area-grow-clip`
