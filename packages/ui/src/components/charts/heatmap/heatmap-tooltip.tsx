    ...
    >
      <div className="overflow-hidden">
        <div className="px-3 py-2.5 text-start">
          <div className="text-chart-tooltip-foreground text-xs font-medium">
            {formatHeatmapTooltipDate(date)}
          </div>
          <div className="text-chart-tooltip-muted mt-0.5 text-xs">
            {formatHeatmapTooltipWeekday(date)}
          </div>
          <div className="border-chart-tooltip-muted/30 my-2 border-t" />
