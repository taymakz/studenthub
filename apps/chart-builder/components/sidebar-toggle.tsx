...
const cloneClasses =
  "fixed z-50 inline-flex size-7 shrink-0 cursor-pointer items-center justify-center rounded-full px-0.5 text-muted-foreground outline-none transition-colors hover:text-foreground focus-visible:text-foreground [&_svg]:size-4"
