          ...
          <div key={day} className="space-y-2">
            ...
            <div className="space-y-2.5">
              {items.map((o) => {
                ...
                return (
                  <button type="button" key={o.index} className="relative w-full cursor-pointer space-y-2 rounded-lg border bg-card px-4 pt-6 pb-4 text-start text-sm" onClick={() => onSelect(o)}>
