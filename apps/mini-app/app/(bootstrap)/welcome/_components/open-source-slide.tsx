...
/** HugeIcons GitHub glyph (user-supplied) - stroke follows currentColor. */
function GithubIcon() {
  return (
    <svg
...
export function OpenSourceSlide() {
  return (
    <SlideShell
      visual={<GithubIcon />}
      title={
        <>
          <span translate="no">دانشجویار</span> اوپن‌سورس است!
        </>
      }
      description="می‌توانید در توسعه آن مشارکت کنید — افزودن دانشگاه، رشته یا چارت تنها با یک Pull Request."
    >
      <Button
        variant="ghost"
        size="sm"
